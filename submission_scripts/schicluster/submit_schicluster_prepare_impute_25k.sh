...
command time hicluster prepare-impute --cell_table $in_file --output_dir $out_dir --chrom_size_path $chrom_file --chr1 0 --pos1 1 --chr2 2 --pos2 3 --cpu_per_job 4 --batch_size $batch_size --output_dist 5050000 \
    --window_size 500000000 \
    --step_size 500000000 --resolution 25000
