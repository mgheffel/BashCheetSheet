...
for fn in ref:
        ...
        dfh1=open(fn+'_bismark_SE_report.txt','r')
        dfh2=open(fn+'_all_merged_3split.bam_multi_split_aligned.txt_Aligned_Fragment_count.txt','r')
        ...
        rfh.write(fn+'\t'+'\t'.join([str(x) for x in data])+'\n')
