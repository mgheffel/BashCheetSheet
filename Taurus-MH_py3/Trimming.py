...
while line1_1:
        if len(line1_2[F_trim:len(line1_2)-B_trim-2])>=50 and len(line2_2[F_trim:len(line2_2)-B_trim-2])>=50:
                rfh1.write(line1_1+line1_2[F_trim:len(line1_2)-B_trim-2]+'\n'+line1_3+line1_4[F_trim:len(line1_2)-B_trim-2]+'\n')
                rfh2.write(line2_1+line2_2[F_trim:len(line2_2)-B_trim-2]+'\n'+line2_3+line2_4[F_trim:len(line2_2)-B_trim-2]+'\n')
        line1_1=dfh1.readline()
        line1_2=dfh1.readline()
        line1_3=dfh1.readline()
        line1_4=dfh1.readline()
